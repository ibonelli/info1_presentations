...
#define MAXBUFLEN 100   /* Max. cantidad de bytes que podra recibir en una 
				llamada a recvfrom() */
main()
{
	int sockfd;
	struct sockaddr_in my_addr;  /* direccion IP y numero de puerto local */
	struct sockaddr_in their_addr; /* direccion IP y numero de puerto 
					del cliente */
...
/* Se establece la estructura my_addr para luego llamar a bind() */
	...
	my_addr.sin_addr.s_addr = INADDR_ANY;  /* se asigna automaticamente 
						la direccion IP local */
