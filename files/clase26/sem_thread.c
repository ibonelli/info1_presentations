/*
 * consumer/producer:
 *           This code is a consumer-producer simulation (over a max-limit on container).
 *           Vary the consumer-rate and the producer-rate (using sleep), to better understand the operation of code. 
 * sem_thread.c - compile with:
 *           gcc -o cpex sem_thread.c -lpthread -lrt
 */
